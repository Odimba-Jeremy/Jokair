    ...
    def ping_loop():
        ...
        while True:
            ...
            try:
                ...
                print(f"✅ Auto-ping envoyé à {now_iso()}")
            except Exception as e:
                try:
                    # Essayer avec l'URL externe si local échoue
                    url = "https://jokair.onrender.com/api/ping"
                    requests.get(url, timeout=5)
                    print(f"✅ Auto-ping envoyé (externe) à {now_iso()}")
                except Exception as e2:
                    print(f"❌ Erreur auto-ping: {str(e2)[:50]}")
